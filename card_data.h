...
PROGMEM const char CARD_NAME_021[] = "Man-o-War";
...
PROGMEM const char CARD_NAME_028[] = "Human Toddler";
...
PROGMEM const char CARD_FLAVOR_013[] = "KEEP AWAY FROM SALT";
PROGMEM const char CARD_FLAVOR_014[] = "SLOW AND STEADY SLAUGHTERS ITS FOES";
PROGMEM const char CARD_FLAVOR_015[] = "TEACH A MAN TO FISH, FEED THEM FOR A DAY. TEACH A FISH TO FISH... WELL";
PROGMEM const char CARD_FLAVOR_016[] = "FULL OF VITAMINS IF IT DOESN'T EAT YOU FIRST";
PROGMEM const char CARD_FLAVOR_017[] = "MENACINGLY LICKING ITS PAWS";
PROGMEM const char CARD_FLAVOR_018[] = "...ELLA, ELLA, ELLA, EH, EH, EH";
PROGMEM const char CARD_FLAVOR_019[] = "SOON IT'LL BE ABLE TO CRAWL TOWARDS YOU";
PROGMEM const char CARD_FLAVOR_020[] = "IT'S CREEPY HOW THEY CONSTANTLY FACE THE SUN";
PROGMEM const char CARD_FLAVOR_021[] = "ITS STINGS ARE AMONG THE MOST PAINFUL EXPERIANCES ONE CAN ENDURE";
PROGMEM const char CARD_FLAVOR_022[] = "AFTER A WHILE, THE SPLASHING GETS ANNOYING";
PROGMEM const char CARD_FLAVOR_023[] = "ITS NATURAL HABITAT IS ON THE SHOULDER OF A DUDE WITH A GOATEE";
PROGMEM const char CARD_FLAVOR_024[] = "DANGEROUS BEFORE SPRING";
PROGMEM const char CARD_FLAVOR_025[] = "YO QUIERO DEVORAR TU ALMA";
PROGMEM const char CARD_FLAVOR_026[] = "SO COMFORTABLE, YOU'LL BE TRAPPED FOREVER";
PROGMEM const char CARD_FLAVOR_027[] = "NOT UGLY";
PROGMEM const char CARD_FLAVOR_028[] = "SOON IT'LL BE ABLE TO WADDLE TOWARDS YOU";
PROGMEM const char CARD_FLAVOR_029[] = "A GREAT SOURCE OF CALAMARI";
PROGMEM const char CARD_FLAVOR_030[] = "PLAYFUL, BUT DON'T GET CAUGHT OFF GUARD";
PROGMEM const char CARD_FLAVOR_031[] = "DING DONG, THEIR ENEMIES ARE DEAD";
PROGMEM const char CARD_FLAVOR_032[] = "DID YOU KNOW: A GROUP OF VULTURES IS CALLED A \"WAKE\"";
PROGMEM const char CARD_FLAVOR_033[] = "ATE MY BABY";
PROGMEM const char CARD_FLAVOR_034[] = "A THOUSAND PAPER CUTS";
PROGMEM const char CARD_FLAVOR_035[] = "THE MEMBER OF CLERGY, NOT THE BIRD";
PROGMEM const char CARD_FLAVOR_036[] = "THE WOMAN THAT I IDOLIZE, OR THE HANDS OF AN AUTOMATON?";
PROGMEM const char CARD_FLAVOR_037[] = "MoooOOOooo";
PROGMEM const char CARD_FLAVOR_038[] = "I DON'T HATE CHIMPAN-A AS MUCH";
PROGMEM const char CARD_FLAVOR_039[] = "ITS MERE EXISTENCE TAUNTS ITS ENEMIES";
PROGMEM const char CARD_FLAVOR_040[] = "ITS DEAFENING SHRILL CAN CAUSE TINNITUS AT WORST";
...
PROGMEM const char CARD_FLAVOR_059[] = "KWEEEEHHH!";
...
PROGMEM const char CARD_FLAVOR_064[] = "ITS ONLY DANGEROUS IF YOU GO IN THE OCEAN";
PROGMEM const char CARD_FLAVOR_065[] = "BASICALLY ALL MUSCLE";
PROGMEM const char CARD_FLAVOR_066[] = "YOUR USUAL BOW AND ARROW TOT'N, POINTY EAR CHAP";
PROGMEM const char CARD_FLAVOR_067[] = "SSSS";
PROGMEM const char CARD_FLAVOR_068[] = "SSSSSSSSSSSS";
PROGMEM const char CARD_FLAVOR_069[] = "HEAD-BANGING HIS WAY TO VICTORY";
PROGMEM const char CARD_FLAVOR_070[] = "DIDN'T SKIP LEG DAY";
PROGMEM const char CARD_FLAVOR_071[] = "LOOK FOR THE BEAR NECESSITIES";
PROGMEM const char CARD_FLAVOR_072[] = "THE NECK BONE'S CONNECTED TO THE SHIN BONE...";
PROGMEM const char CARD_FLAVOR_073[] = "NEVER FORGETS... TO KILL";
PROGMEM const char CARD_FLAVOR_074[] = "BIPPITY BOPPITY BOO";
PROGMEM const char CARD_FLAVOR_075[] = "REVIVED FROM AMBER TO RULE THE LAND AGAIN";
PROGMEM const char CARD_FLAVOR_076[] = "THE SOURCE OF LUNACY";
PROGMEM const char CARD_FLAVOR_077[] = "FUNNY HOW? LIKE A CLOWN";
PROGMEM const char CARD_FLAVOR_078[] = "LOVES TO GIVE HUGS, DO NOT RECIPROCATE";
PROGMEM const char CARD_FLAVOR_079[] = "ITS ONLY WEAKNESS IS A FARMER AND HIS TRACTOR";
PROGMEM const char CARD_FLAVOR_080[] = "HUNTING RED OCTOBER";
PROGMEM const char CARD_FLAVOR_081[] = "20 20 20 VISION";
PROGMEM const char CARD_FLAVOR_082[] = "IT CAME FROM OUTER SPACE";
PROGMEM const char CARD_FLAVOR_083[] = "DESPITE ITS SMALL SIZE, CAN STILL BREATH FIRE";
PROGMEM const char CARD_FLAVOR_084[] = "ITS MOST POWERFUL PART IS THE NOSE";
PROGMEM const char CARD_FLAVOR_085[] = "HIS MOTHER NAMED HIM STABBY McGEE";
PROGMEM const char CARD_FLAVOR_086[] = "FORESTWALK\n\n              1/1";
PROGMEM const char CARD_FLAVOR_087[] = "A LOVER AND A FIGHTER";
PROGMEM const char CARD_FLAVOR_088[] = "DOES NOT LOVE";
PROGMEM const char CARD_FLAVOR_089[] = "MOTHER OF CERBERUS, CHIMERA, AND THE SPHINX";
PROGMEM const char CARD_FLAVOR_090[] = "THIS ONE KILLED THE DINOSAURS";
PROGMEM const char CARD_FLAVOR_091[] = "THE SCREECHING IS A DEATHLY OMEN FOR THOSE WHO HEARS";
PROGMEM const char CARD_FLAVOR_092[] = "WATCH YOUR BACK";
PROGMEM const char CARD_FLAVOR_093[] = "HUNTS THE MOST DANGEROUS GAME";
PROGMEM const char CARD_FLAVOR_094[] = "NO MENTAL POWERS";
PROGMEM const char CARD_FLAVOR_095[] = "AIMS TO COMPRESS TIME";
PROGMEM const char CARD_FLAVOR_096[] = "THE MESSENGER, GOD OF THEIVES";
PROGMEM const char CARD_FLAVOR_097[] = "\"I LOVE GOOOOLD\"";
